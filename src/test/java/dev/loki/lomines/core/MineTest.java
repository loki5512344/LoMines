...
import dev.loki.lomines.block.BukkitBlockSetter;
import dev.loki.lomines.block.ItemsAdderBlockSetter;
import dev.loki.lomines.block.OraxenBlockSetter;
import dev.loki.lomines.data.MineConfig;
...
class MineTest {
    ...
    void testCreateBlockSetter_WithOraxenPrefix_CreatesOraxenBlockSetter() {
        ...
        assertInstanceOf(OraxenBlockSetter.class, mine.getBlockSetter(), "Expected OraxenBlockSetter for oraxen: prefix");
    }
    ...
    void testCreateBlockSetter_WithItemsAdderPrefix_CreatesItemsAdderBlockSetter() {
        ...
        // Assert
        assertNotNull(mine.getBlockSetter());
        assertInstanceOf(ItemsAdderBlockSetter.class, mine.getBlockSetter(), "Expected ItemsAdderBlockSetter for itemsadder: prefix");
    }
    ...
    void testCreateBlockSetter_WithoutPrefix_CreatesBukkitBlockSetter() {
        ...
        // Assert
        assertNotNull(mine.getBlockSetter());
        assertInstanceOf(BukkitBlockSetter.class, mine.getBlockSetter(), "Expected BukkitBlockSetter for vanilla blocks without prefix");
    }
