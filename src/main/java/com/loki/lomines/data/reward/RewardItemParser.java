...
final class RewardItemParser {
     ...
     */
    ItemStack parseItem(Map<String, Object> itemMap, int index) throws ConfigParseException {
    ...
    private Material parseMaterial(String typeName) throws ConfigParseException {
        try {
            return Material.valueOf(typeName.toUpperCase());
